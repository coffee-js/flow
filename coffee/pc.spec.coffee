...
describe "Parser Combinator", ->
  ...
  describe "ws", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "12345 abd", 5).state.lastFailPos).toEqual 8
  ...
  describe "choice", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "1234567\t\nabc", 6).state.lastFailPos).toEqual 6
      (expect (p pc.ps "12345acb", 5).state.lastFailPos).toEqual 6
      (expect (p pc.ps "12345xyx", 5).state.lastFailPos).toEqual 7
  ...
  describe "seq", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "12345abc y2", 5).state.lastFailPos).toEqual null
  ...
  describe "optional", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "12345abc", 5).state.lastFailPos).toEqual null
      (expect (p pc.ps "12345abd", 5).state.lastFailPos).toEqual null
  ...
  describe "rep0", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "12345abcabc", 5).state.pos).toEqual 11
      (expect (p pc.ps "12345abcabd", 5).state.pos).toEqual 8
  ...
  describe "rep1", ->
    ...
    it "save last fail pos", ->
      ...
      (expect (p pc.ps "12345abcabcbbc", 5).state.lastFailPos).toEqual null
      (expect (p pc.ps "12345abdabc", 5).state.lastFailPos).toEqual 7
  ...
  describe "neg", ->
	...
	describe "map", ->
		...
		it "save last fail pos", ->
			...
			(expect (p pc.ps "12345abc", 5).state.lastFailPos).toEqual null
			(expect (p pc.ps "12345abd", 5).state.lastFailPos).toEqual 7
